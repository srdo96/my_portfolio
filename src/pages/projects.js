...
const FeaturedProject = ({
  ...
  return (
    <article className="w-full p-12  flex items-center justify-between rounded-3xl border border-solid border-dark bg-light dark:bg-dark shadow-2xl dark:border-light ">
